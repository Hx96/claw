...
```text
~/.openclaw/workspace/fit-coach/
```

Create this directory when needed. Use these files:

```text
~/.openclaw/workspace/fit-coach/profile.md
~/.openclaw/workspace/fit-coach/goals.md
~/.openclaw/workspace/fit-coach/food-options.md
~/.openclaw/workspace/fit-coach/current-plan.md
~/.openclaw/workspace/fit-coach/daily-log.md
~/.openclaw/workspace/fit-coach/weekly-review.md
```
